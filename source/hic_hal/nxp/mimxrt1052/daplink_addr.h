...
#define DAPLINK_ROM_START               0x60002000 // code alias
#define DAPLINK_ROM_SIZE                0x00200400 // 8MB

#define DAPLINK_RAM_START               0x20000000 // dtcm alias
#define DAPLINK_RAM_SIZE                0x00020000 // 128KB

/* ROM sizes */

#define DAPLINK_ROM_BL_START            0x60002000
#define DAPLINK_ROM_BL_SIZE             0x00100000 // 1 MB bootloader

#define DAPLINK_ROM_IF_START            0x60102000 
#define DAPLINK_ROM_IF_SIZE             0x00100000 // 1 MB interface

#define DAPLINK_ROM_CONFIG_USER_START   0x60202000
...
#define DAPLINK_RAM_SHARED_START        0x20200000
#define DAPLINK_RAM_SHARED_SIZE         0x00040000
