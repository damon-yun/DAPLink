...
// This GPIO configuration is only valid for the RT1052 HIC
COMPILER_ASSERT(DAPLINK_HIC_ID == DAPLINK_HIC_ID_MIMXRT1052);

// All pins are GPIO1.
#define PIN_PIO_PORT            (GPIO1)

// Debug Port I/O Pins

// SWCLK Pin                    PIO1_31 (O)
#define PIN_TCK_SWCLK           (31U)
#define PIN_TCK_SWCLK_MASK      (1U << PIN_TCK_SWCLK)

// SWDIO I/O Pin                PIO1_28 (IO)
// port always has pull-down and digital input (DIGIMODE) enabled (UM11126, section 15.5.1, table 312)
#define PIN_TMS_SWDIO           (28U)
#define PIN_TMS_SWDIO_MASK      (1U << PIN_TMS_SWDIO)

// SWDIO Output Enable Pin      PIO0_28 (O)
// (DBGIF_TMS_SWDIO_TXEN)
#define PIN_TMS_SWDIO_TXEN      (19U)
...
#define PIN_TDO_SWO             (30U)
#define PIN_TDO_SWO_MASK        (1U << PIN_TDO_SWO)

// nRESET Pin                   PIO1_29 (O)
// (DBGIF_RESET)
...
#define LED_A_PORT              (GPIO1)
#define LED_A_PIN               (19U)
